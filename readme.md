...
If this concept is new, check out the post on [markov chain attribution modeling](https://www.avayant.com/post/building-an-attribution-model-with-markov-chains).   
