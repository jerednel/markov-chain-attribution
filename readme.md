...
If this concept is new, check out the post on [markov chain attribution modeling](https://write.as/bitshifter/building-an-attribution-model-with-markov-chains).   
